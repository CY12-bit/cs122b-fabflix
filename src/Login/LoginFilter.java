...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        System.out.println("Login.LoginFilter: " + httpRequest.getRequestURI());
        ...
        if (httpRequest.getSession().getAttribute("user") == null && httpRequest.getSession().getAttribute("employee") == null) {
            ...
            httpResponse.sendRedirect("/cs122b_projects_war/login.html"); // Change it to /cs122b-projects/login.html for AWS. cs122b_projects_war for local.
        } else {
            chain.doFilter(request, response);
        }
    }
